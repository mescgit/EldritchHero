...
export interface InitOutput {
  ...
  readonly closure13182_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure13656_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7952ddc0fd521975: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h168e571d6b31c4d3: (a: number, b: number) => void;
  readonly closure64356_externref_shim: (a: number, b: number, c: any) => void;
