...
use crate::{
    ...
    items::{ItemLibrary, ItemId}, 
    // skills::{SkillLibrary}, // SkillLibrary commented out as unused
    survivor::Survivor,
};
...
fn setup_debug_menu_ui(
    ...
    _skill_library: Res<crate::skills::SkillLibrary>, 
    _weapon_library: Res<crate::items::AutomaticWeaponLibrary>, 
