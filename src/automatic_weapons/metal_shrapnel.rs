...
pub fn define_metal_shrapnel() -> AutomaticWeaponDefinition {
    AutomaticWeaponDefinition {
        ...
        attack_data: AttackTypeData::PersistentAura(PersistentAuraParams {
            ...
            activation_sound_effect: Some("assets/audio/metal_shrapnel_activate.ogg".to_string()),
            deactivation_sound_effect: Some("assets/audio/metal_shrapnel_deactivate.ogg".to_string()),
        }),
    }
}
