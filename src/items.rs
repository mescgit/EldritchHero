...
pub struct LobbedBouncingMagmaParams {
    ...
    pub max_bounces: u32,
    pub fire_pool_chance_per_bounce: f32, // 0.0 to 1.0
    ...
    pub arc_height: f32, // Similar to LobbedAoEPoolParams
}
...
pub enum AttackTypeData {
    ...
    LobbedBouncingMagma(LobbedBouncingMagmaParams), // Added new type for Magma Ball
...
impl Plugin for ItemsPlugin {
    fn build(&self, app: &mut App) {
        app .register_type::<ItemId>() .register_type::<SurvivorTemporaryBuff>() .register_type::<ItemEffect>() .register_type::<ItemLibrary>()
            ...
            .register_type::<LobbedBouncingMagmaParams>() // Register new LobbedBouncingMagmaParams
...
fn populate_automatic_weapon_library(mut library: ResMut<AutomaticWeaponLibrary>) {
    ...
    library.weapons.push(AutomaticWeaponDefinition {
        ...
        attack_data: AttackTypeData::ChanneledBeam(ChanneledBeamParams {
            base_damage_per_tick: 5, // Changed from base_damage
            tick_rate_secs: 0.15, // New field, how often damage applies
            range: 450.0, // Changed from base_projectile_speed (conceptual difference)
            beam_width: 20.0, // New field
            beam_color: Color::rgb(0.7, 0.2, 0.9), // Kept projectile_color
            movement_penalty_multiplier: 0.6, // New field, e.g., 60% of normal speed while firing
        }),
    });
    ...
    library.weapons.push(AutomaticWeaponDefinition {
        ...
        attack_data: AttackTypeData::LobbedAoEPool(LobbedAoEPoolParams {
            base_damage_on_impact: 10, // Kept from base_damage
            pool_damage_per_tick: 5,   // New: Damage per tick in the pool
            base_fire_rate_secs: 0.7,  // Adjusted from 0.4
            projectile_speed: 350.0,   // Adjusted from 500.0
            projectile_sprite_path: "sprites/auto_venom_spit_projectile.png", // Potentially new sprite for the lobbed part
            projectile_size: Vec2::new(25.0, 25.0), // Adjusted
            projectile_color: Color::rgb(0.2, 0.8, 0.1), // Kept
            projectile_arc_height: 40.0, // New: Arc for the lob
            pool_radius: 70.0,          // New: Radius of the AoE pool
            pool_duration_secs: 3.0,    // New: How long the pool lasts
            pool_tick_interval_secs: 0.5, // New: How often pool damage ticks
            pool_color: Color::rgba(0.2, 0.6, 0.1, 0.5), // New: Color for the pool itself
            max_active_pools: 3,       // New: Limit on active pools
        }),
    });
    ...
    library.weapons.push(AutomaticWeaponDefinition {
        ...
        attack_data: AttackTypeData::LobbedBouncingMagma(LobbedBouncingMagmaParams {
            ...
            damage: 25, // Damage on direct hit
            speed: 450.0,
            sprite_path: "sprites/magma_ball_projectile_placeholder.png", // Placeholder
            sprite_size: Vec2::new(35.0, 35.0),
            sprite_color: Color::rgb(1.0, 0.4, 0.0),
            lifetime_secs: 4.0,
            max_bounces: 3,
            fire_pool_chance_per_bounce: 0.75, // 75% chance to leave a pool
            fire_pool_damage_per_tick: 5,
            fire_pool_radius: 60.0,
            fire_pool_duration_secs: 3.0,
            fire_pool_tick_interval_secs: 0.5,
            fire_pool_color: Color::rgba(1.0, 0.3, 0.0, 0.6),
            arc_height: 60.0,
        }),
    });
